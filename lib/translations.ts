      ...
      tabs: [
        ...
        },
        {
          ...
          faqs: [
            ...
            { id: 'laundry-card-cost', question: 'How much is a laundry card?', answer: "Laundry cards are $1 each, available from the kiosk inside the laundromat. Once you have one, you can reload it with cash or card at any time." },
      ...
      tabs: [
        ...
        },
        {
          ...
          faqs: [
            ...
            { id: 'laundry-card-cost', question: '¿Cuánto cuesta una tarjeta de lavandería?', answer: 'Las tarjetas de lavandería cuestan $1 cada una, disponibles en el kiosco dentro de la lavandería. Una vez que tenga una, puede recargarla con efectivo o tarjeta en cualquier momento.' },
